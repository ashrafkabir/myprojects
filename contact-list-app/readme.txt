...
(2/5) Angular JS and Node JS App Tutorial - MEAN Stack RESTful API Tutorial, Part 2
...
(4/5) RESTful API, GET and POST Data - MEAN Stack Tutorial, Part 4
https://www.youtube.com/watch?v=iFsYJG3fGro

(5/5) RESTful API Tutorial, DELETE and PUT Data - MEAN Stack RESTful API Tutorial, Part 5
